...
MESSAGES = [
    b"From: lab7a@example.com\r\nTo: student@localhost\r\nSubject: Lab7 A\r\n\r\nWiadomosc A dla zadania 7.\r\n",
    b"From: lab7b@example.com\r\nTo: student@localhost\r\nSubject: Lab7 B\r\n\r\nWiadomosc B dla zadania 7, dluzsza od A.\r\n",
    b"From: lab7c@example.com\r\nTo: student@localhost\r\nSubject: Lab7 C\r\n\r\nWiadomosc C dla zadania 7.\r\n",
]
...
def handle_client(conn: socket.socket, addr: tuple[str, int]) -> None:
    print(f"[serwer_lab7] Klient polaczony: {addr[0]}:{addr[1]}")
    ...
    send_line(conn, "+OK POP3 lab7 ready")
    ...
    print(f"[serwer_lab7] Klient rozlaczony: {addr[0]}:{addr[1]}")


def main() -> None:
    print(f"[serwer_lab7] Start on {HOST}:{PORT}")
    print(f"[serwer_lab7] Login: {USERNAME}")
    print(f"[serwer_lab7] Haslo: {PASSWORD}")
