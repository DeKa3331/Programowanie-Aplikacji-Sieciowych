...
MESSAGES = [
    b"From: lab12a@example.com\r\nTo: student@localhost\r\nSubject: Lab12 A\r\n\r\nTo jest pierwsza testowa wiadomosc serwera POP3.\r\n",
    b"From: lab12b@example.com\r\nTo: student@localhost\r\nSubject: Lab12 B\r\n\r\nTo jest druga testowa wiadomosc.\r\n",
]
...
def handle_client(conn: socket.socket, addr: tuple[str, int]) -> None:
    print(f"[serwer_lab12] Klient polaczony: {addr[0]}:{addr[1]}")
    ...
    send_line(conn, "+OK POP3 lab12 ready")
    ...
    print(f"[serwer_lab12] Klient rozlaczony: {addr[0]}:{addr[1]}")


def main() -> None:
    print(f"[serwer_lab12] Start on {HOST}:{PORT}")
    print(f"[serwer_lab12] Login: {USERNAME}")
    print(f"[serwer_lab12] Haslo: {PASSWORD}")
