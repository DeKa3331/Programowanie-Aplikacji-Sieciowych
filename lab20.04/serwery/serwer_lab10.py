...
MESSAGES = [
    b"From: lab10a@example.com\r\nTo: student@localhost\r\nSubject: Lab10 A\r\n\r\nPierwsza wiadomosc do wyswietlenia.\r\n",
    b"From: lab10b@example.com\r\nTo: student@localhost\r\nSubject: Lab10 B\r\n\r\nDruga wiadomosc do wyswietlenia.\r\n",
    b"From: lab10c@example.com\r\nTo: student@localhost\r\nSubject: Lab10 C\r\n\r\nTrzecia wiadomosc do wyswietlenia.\r\n",
]
...
def handle_client(conn: socket.socket, addr: tuple[str, int]) -> None:
    print(f"[serwer_lab10] Klient polaczony: {addr[0]}:{addr[1]}")
    ...
    send_line(conn, "+OK POP3 lab10 ready")
    ...
    print(f"[serwer_lab10] Klient rozlaczony: {addr[0]}:{addr[1]}")


def main() -> None:
    print(f"[serwer_lab10] Start on {HOST}:{PORT}")
    print(f"[serwer_lab10] Login: {USERNAME}")
    print(f"[serwer_lab10] Haslo: {PASSWORD}")
