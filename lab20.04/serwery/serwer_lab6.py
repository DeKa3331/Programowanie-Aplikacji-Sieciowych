...
MESSAGES = [
    b"From: lab6a@example.com\r\nTo: student@localhost\r\nSubject: Lab6 A\r\n\r\nWiadomosc 1 dla zadania 6.\r\n",
    b"From: lab6b@example.com\r\nTo: student@localhost\r\nSubject: Lab6 B\r\n\r\nWiadomosc 2 dla zadania 6.\r\n",
]
...
def handle_client(conn: socket.socket, addr: tuple[str, int]) -> None:
    print(f"[serwer_lab6] Klient polaczony: {addr[0]}:{addr[1]}")
    ...
    send_line(conn, "+OK POP3 lab6 ready")
    ...
    print(f"[serwer_lab6] Klient rozlaczony: {addr[0]}:{addr[1]}")


def main() -> None:
    print(f"[serwer_lab6] Start on {HOST}:{PORT}")
    print(f"[serwer_lab6] Login: {USERNAME}")
    print(f"[serwer_lab6] Haslo: {PASSWORD}")
