...
MESSAGES = [
    b"From: lab3a@example.com\r\nTo: student@localhost\r\nSubject: Lab3 A\r\n\r\nWiadomosc A dla zadania 3.\r\n",
    b"From: lab3b@example.com\r\nTo: student@localhost\r\nSubject: Lab3 B\r\n\r\nWiadomosc B dla zadania 3, nieco dluzsza.\r\n",
    b"From: lab3c@example.com\r\nTo: student@localhost\r\nSubject: Lab3 C\r\n\r\nWiadomosc C dla zadania 3.\r\n",
]
...
def handle_client(conn: socket.socket, addr: tuple[str, int]) -> None:
    print(f"[serwer_lab3] Klient polaczony: {addr[0]}:{addr[1]}")
    ...
    send_line(conn, "+OK POP3 lab3 ready")
    ...
    print(f"[serwer_lab3] Klient rozlaczony: {addr[0]}:{addr[1]}")


def main() -> None:
    print(f"[serwer_lab3] Start on {HOST}:{PORT}")
    print(f"[serwer_lab3] Login: {USERNAME}")
    print(f"[serwer_lab3] Haslo: {PASSWORD}")
