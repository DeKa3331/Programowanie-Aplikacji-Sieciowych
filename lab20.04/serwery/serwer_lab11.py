...
PNG_1X1_BASE64 = (
    "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/w8AAusB9Y9n7hEAAAAASUVORK5CYII="
)

ATTACHMENT_MAIL = (
    "From: lab11@example.com\r\n"
    "To: student@localhost\r\n"
    "Subject: Lab11 attachment\r\n"
    "MIME-Version: 1.0\r\n"
    "Content-Type: multipart/mixed; boundary=\"BOUNDARY-LAB11\"\r\n"
    "\r\n"
    "--BOUNDARY-LAB11\r\n"
    "Content-Type: text/plain; charset=utf-8\r\n"
    "\r\n"
    "W tej wiadomosci jest obrazek jako zalacznik.\r\n"
    "\r\n"
    "--BOUNDARY-LAB11\r\n"
    "Content-Type: image/png; name=\"lab11-obrazek.png\"\r\n"
    "Content-Transfer-Encoding: base64\r\n"
    "Content-Disposition: attachment; filename=\"lab11-obrazek.png\"\r\n"
    "\r\n"
    f"{PNG_1X1_BASE64}\r\n"
    "--BOUNDARY-LAB11--\r\n"
).encode("utf-8")
...
MESSAGES = [
    b"From: lab11a@example.com\r\nTo: student@localhost\r\nSubject: Lab11 plain\r\n\r\nTo jest zwykla wiadomosc bez zalacznika.\r\n",
    ATTACHMENT_MAIL,
]
...
def handle_client(conn: socket.socket, addr: tuple[str, int]) -> None:
    print(f"[serwer_lab11] Klient polaczony: {addr[0]}:{addr[1]}")
    ...
    send_line(conn, "+OK POP3 lab11 ready")
    ...
    print(f"[serwer_lab11] Klient rozlaczony: {addr[0]}:{addr[1]}")


def main() -> None:
    print(f"[serwer_lab11] Start on {HOST}:{PORT}")
    print(f"[serwer_lab11] Login: {USERNAME}")
    print(f"[serwer_lab11] Haslo: {PASSWORD}")
