...
MESSAGES = [
    b"From: lab5a@example.com\r\nTo: student@localhost\r\nSubject: Lab5 A\r\n\r\nMala.\r\n",
    b"From: lab5b@example.com\r\nTo: student@localhost\r\nSubject: Lab5 B\r\n\r\nSrednia wiadomosc dla testu usuwania.\r\n",
    b"From: lab5c@example.com\r\nTo: student@localhost\r\nSubject: Lab5 C\r\n\r\nDuza wiadomosc dla testu usuwania.\r\nDodatkowa linia.\r\n",
]
...
def handle_client(conn: socket.socket, addr: tuple[str, int]) -> None:
    print(f"[serwer_lab5] Klient polaczony: {addr[0]}:{addr[1]}")
    ...
    send_line(conn, "+OK POP3 lab5 ready")
    ...
    print(f"[serwer_lab5] Klient rozlaczony: {addr[0]}:{addr[1]}")


def main() -> None:
    print(f"[serwer_lab5] Start on {HOST}:{PORT}")
    print(f"[serwer_lab5] Login: {USERNAME}")
    print(f"[serwer_lab5] Haslo: {PASSWORD}")
