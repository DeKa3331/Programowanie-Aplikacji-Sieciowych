...
MESSAGES = [
    b"From: lab4a@example.com\r\nTo: student@localhost\r\nSubject: Lab4 A\r\n\r\nKrotka wiadomosc.\r\n",
    b"From: lab4b@example.com\r\nTo: student@localhost\r\nSubject: Lab4 B\r\n\r\nTo jest najdluzsza wiadomosc dla zadania 4.\r\nMa kilka linii tekstu, aby RETR mial co wyswietlac.\r\nKolejna linia tresci.\r\n",
    b"From: lab4c@example.com\r\nTo: student@localhost\r\nSubject: Lab4 C\r\n\r\nSrednia wiadomosc.\r\n",
]
...
def handle_client(conn: socket.socket, addr: tuple[str, int]) -> None:
    print(f"[serwer_lab4] Klient polaczony: {addr[0]}:{addr[1]}")
    ...
    send_line(conn, "+OK POP3 lab4 ready")
    ...
    print(f"[serwer_lab4] Klient rozlaczony: {addr[0]}:{addr[1]}")


def main() -> None:
    print(f"[serwer_lab4] Start on {HOST}:{PORT}")
    print(f"[serwer_lab4] Login: {USERNAME}")
    print(f"[serwer_lab4] Haslo: {PASSWORD}")
