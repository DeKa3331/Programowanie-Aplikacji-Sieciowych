...
MESSAGES = [
    b"From: lab9a@example.com\r\nTo: student@localhost\r\nSubject: Lab9 A\r\n\r\nKrotka wiadomosc.\r\n",
    b"From: lab9b@example.com\r\nTo: student@localhost\r\nSubject: Lab9 B\r\n\r\nTo jest najwieksza wiadomosc dla zadania 9.\r\nMa kilka linii tekstu do wyswietlenia przez klienta.\r\nJeszcze jedna linia.\r\n",
    b"From: lab9c@example.com\r\nTo: student@localhost\r\nSubject: Lab9 C\r\n\r\nSrednia wiadomosc.\r\n",
]
...
def handle_client(conn: socket.socket, addr: tuple[str, int]) -> None:
    print(f"[serwer_lab9] Klient polaczony: {addr[0]}:{addr[1]}")
    ...
    send_line(conn, "+OK POP3 lab9 ready")
    ...
    print(f"[serwer_lab9] Klient rozlaczony: {addr[0]}:{addr[1]}")


def main() -> None:
    print(f"[serwer_lab9] Start on {HOST}:{PORT}")
    print(f"[serwer_lab9] Login: {USERNAME}")
    print(f"[serwer_lab9] Haslo: {PASSWORD}")
